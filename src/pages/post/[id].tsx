...
const PostPage = ({ id }: PostPageProps) => {
    ...
    return (
        <>
            ...
            <header className="sticky top-0 z-10 p-2 backdrop-blur-lg dark:bg-black/80 bg-white/80 flex gap-5 items-center">
                <Link className="rounded-full p-2 dark:hover:bg-zinc-900 hover:bg-gray-100"  href="..">
                    <VscArrowLeft className="h-5 w-5 text-gray-600 dark:text-zinc-200" />
                </Link>

                <h2 className="font-medium text-xl">Tweet</h2>
            </header>
            <main>
                <article className="m-5  space-y-2 dark:border-zinc-800 border-b">
